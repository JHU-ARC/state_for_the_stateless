       ...
       int __maxevents, int __timeout)
{
	...
	// printf ("Call epoll_wait: %d %d %d %d \n", __epfd, __maxevents, __timeout, pthread_self());
...
int ocall_epoll_wait1 (int __epfd, void *__events, int event_size,
       int __maxevents, int __timeout)
{
	// struct epoll_event *events = (struct epoll_event *) __events;
	struct epoll_event* events = (struct epoll_event*)malloc(sizeof(struct epoll_event)*__maxevents);
	int maxevents = __maxevents;
	int timeout = __timeout;
	// printf ("Call epoll_wait1: %d %d %d %d \n", __epfd, __maxevents, __timeout, pthread_self());
	int ret = epoll_wait(__epfd, events, maxevents, timeout);
	// printf ("epoll wait return :%d\n", ret);
	if (ret>0)	{
		// printf ("The ptr is: %p \n The type is: %d \n", events[0].data.ptr, events[0].events);
...
int ocall_epoll_wait2 (int __epfd, void *__events, int event_size,
       int __maxevents, int __timeout)
{
	// struct epoll_event *events = (struct epoll_event *) __events;
	struct epoll_event* events = (struct epoll_event*)malloc(sizeof(struct epoll_event)*__maxevents);
	int maxevents = __maxevents;
	int timeout = __timeout;
	// printf ("Call epoll_wait2: %d %d %d %d \n", __epfd, __maxevents, __timeout, pthread_self());
	int ret = epoll_wait(__epfd, events, maxevents, timeout);
	// printf ("epoll wait return :%d\n", ret);
	if (ret>0)	{
		// printf ("The ptr is: %p \n The type is: %d \n", events[0].data.ptr, events[0].events);
...
int ocall_epoll_wait3 (int __epfd, void *__events, int event_size,
       int __maxevents, int __timeout)
{
	// struct epoll_event *events = (struct epoll_event *) __events;
	struct epoll_event* events = (struct epoll_event*)malloc(sizeof(struct epoll_event)*__maxevents);
	int maxevents = __maxevents;
	int timeout = __timeout;
	// printf ("Call epoll_wait3: %d %d %d %d \n", __epfd, __maxevents, __timeout, pthread_self());
	int ret = epoll_wait(__epfd, events, maxevents, timeout);
	// printf ("epoll wait return :%d\n", ret);
	if (ret>0)	{
		// printf ("The ptr is: %p \n The type is: %d \n", events[0].data.ptr, events[0].events);
...
int ocall_epoll_wait4 (int __epfd, void *__events, int event_size,
       int __maxevents, int __timeout)
{
	// struct epoll_event *events = (struct epoll_event *) __events;
	struct epoll_event* events = (struct epoll_event*)malloc(sizeof(struct epoll_event)*__maxevents);
	int maxevents = __maxevents;
	int timeout = __timeout;
	// printf ("Call epoll_wait4: %d %d %d %d \n", __epfd, __maxevents, __timeout, pthread_self());
	int ret = epoll_wait(__epfd, events, maxevents, timeout);
	// printf ("epoll wait return :%d\n", ret);
	if (ret>0)	{
		// printf ("The ptr is: %p \n The type is: %d \n", events[0].data.ptr, events[0].events);
...
int ocall_epoll_wait5 (int __epfd, void *__events, int event_size,
       int __maxevents, int __timeout)
{
	// struct epoll_event *events = (struct epoll_event *) __events;
	struct epoll_event* events = (struct epoll_event*)malloc(sizeof(struct epoll_event)*__maxevents);
	int maxevents = __maxevents;
	int timeout = __timeout;
	// printf ("Call epoll_wait5: %d %d %d %d \n", __epfd, __maxevents, __timeout, pthread_self());
	int ret = epoll_wait(__epfd, events, maxevents, timeout);
	// printf ("epoll wait return :%d\n", ret);
	if (ret>0)	{
		// printf ("The ptr is: %p \n The type is: %d \n", events[0].data.ptr, events[0].events);
...
int ocall_epoll_wait6 (int __epfd, void *__events, int event_size,
       int __maxevents, int __timeout)
{
	// struct epoll_event *events = (struct epoll_event *) __events;
	struct epoll_event* events = (struct epoll_event*)malloc(sizeof(struct epoll_event)*__maxevents);
	int maxevents = __maxevents;
	int timeout = __timeout;
	// printf ("Call epoll_wait6: %d %d %d %d \n", __epfd, __maxevents, __timeout, pthread_self());
	int ret = epoll_wait(__epfd, events, maxevents, timeout);
	// printf ("epoll wait return :%d\n", ret);
	if (ret>0)	{
		// printf ("The ptr is: %p \n The type is: %d \n", events[0].data.ptr, events[0].events);
...
int ocall_epoll_wait7 (int __epfd, void *__events, int event_size,
       int __maxevents, int __timeout)
{
	// struct epoll_event *events = (struct epoll_event *) __events;
	struct epoll_event* events = (struct epoll_event*)malloc(sizeof(struct epoll_event)*__maxevents);
	int maxevents = __maxevents;
	int timeout = __timeout;
	// printf ("Call epoll_wait7: %d %d %d %d \n", __epfd, __maxevents, __timeout, pthread_self());
	int ret = epoll_wait(__epfd, events, maxevents, timeout);
	// printf ("epoll wait return :%d\n", ret);
	if (ret>0)	{
		// printf ("The ptr is: %p \n The type is: %d \n", events[0].data.ptr, events[0].events);
